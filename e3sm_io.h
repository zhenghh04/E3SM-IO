...
#ifdef ENABLE_NETCDF4
extern int nc_put_varn (int ncid,
                        int varid,
                        int nreq,
                        size_t **starts,
                        size_t **counts,
...
extern int nc_get_varn (int ncid,
                        int varid,
                        int nreq,
                        size_t **starts,
                        size_t **counts,
...
extern int def_F_case_h0_nc4 (int ncid,             /* file ID */
                              const size_t dims[2], /* dimension sizes */
                              int nvars,            /* number of variables */
                              int *varids);         /* variable IDs */
extern int def_F_case_h1_nc4 (int ncid,             /* file ID */
                              const size_t dims[2], /* dimension sizes */
                              int nvars,            /* number of variables */
                              int *varids);         /* variable IDs */
extern int inq_F_case_h0_nc4 (int ncid,             /* file ID */
                              size_t dims[2],       /* dimension sizes */
                              int nvars,            /* number of variables */
                              int *varids);         /* variable IDs */
extern int inq_F_case_h1_nc4 (int ncid,             /* file ID */
                              size_t dims[2],       /* dimension sizes */
                              int nvars,            /* number of variables */
                              int *varids);         /* variable IDs */

extern int run_varn_F_case_nc4 (
    MPI_Comm io_comm,    /* MPI communicator that includes all the tasks involved in IO */
    const char *out_dir, /* output folder name */
    const char *outfile, /* output file name */
    int nvars,           /* number of variables 408 or 51 */
...
extern int run_varn_F_case_rd_nc4 (
    MPI_Comm io_comm,  /* MPI communicator that includes all the tasks involved in IO */
    char *out_dir,     /* output folder name */
    char *outfile,     /* output file name */
    int nvars,         /* number of variables 408 or 51 */
...
extern int def_G_case_h0_nc4 (int ncid,                /* file ID */
...
extern int inq_G_case_h0_nc4 (int ncid,          /* file ID */
...
extern int run_varn_G_case_nc4 (
    MPI_Comm io_comm,    /* MPI communicator that includes all the tasks involved in IO */
    const char *out_dir, /* output folder name */
    const char *outfile, /* output file name */
    int nvars,           /* number of variables 51 */
...
extern int run_varn_G_case_rd_nc4 (
    MPI_Comm io_comm, /* MPI communicator that includes all the tasks involved in IO */
    char *out_dir,    /* output folder name */
    char *outfile,    /* output file name */
    int nvars,        /* number of variables 51 */
