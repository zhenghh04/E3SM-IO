...
static int define_global_attributes (int ncid) {
    ...
    err = nc_put_att_text (ncid, NC_GLOBAL, "on_a_sphere", 3, "YES");
    NC4ERR
    dattr = 6371229.;
    err   = nc_put_att (ncid, NC_GLOBAL, "sphere_radius", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "model_name", 4, "mpas");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "core_name", 5, "ocean");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "history", 28, "mpirun -n 9600 ./ocean_model");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "source", 4, "MPAS");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "Conventions", 4, "MPAS");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "parent_id", 65,
                         "mt6vdoeok9\nrz1tbn0bed\n555vk5hkh9\n0s1lcmezuy\n7z1uysqc5i\nwj661vqvze");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "mesh_spec", 3, "0.0");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "git_version", 16, "MPAS_GIT_VERSION");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_ocean_run_mode", 7, "forward");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_do_restart", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_restart_timestamp_name", 12, "rpointer.ocn");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_start_time", 19, "0001-01-01_00:00:00");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_stop_time", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_run_duration", 19, "0001-00-00_00:00:00");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_calendar_type", 16, "gregorian_noleap");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_write_output_on_startup", 2, "NO");
    NC4ERR
    iattr = 0;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_pio_num_iotasks", NC_INT, 1, &iattr);
    NC4ERR
    iattr = 1;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_pio_stride", NC_INT, 1, &iattr);
    NC4ERR
    iattr = 3;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_num_halos", NC_INT, 1, &iattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_block_decomp_file_prefix", 89,
                           "/project/projectdirs/acme/inputdata/ocn/mpas-o/oRRS18to6v3/"
                           "mpas-o.graph.info.170111.part.");
    NC4ERR
    iattr = 0;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_number_of_blocks", NC_INT, 1, &iattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_explicit_proc_decomp", 2, "NO");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_proc_decomp_file_prefix", 16, "graph.info.part.");
    NC4ERR
    iattr = -1;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_vert_levels", NC_INT, 1, &iattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_init_configuration", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_expand_sphere", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_realistic_coriolis_parameter", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_write_cull_cell_mask", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_vertical_grid", 7, "uniform");
    NC4ERR
    dattr = 1.077;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_1dCVTgenerator_stretch1", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1.0275;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_1dCVTgenerator_stretch2", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1.2;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_1dCVTgenerator_dzSeed", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_iterative_init_variable", 15, "landIcePressure");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_dt", 8, "00:06:00");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_time_integrator", 14, "split_explicit");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_vert_coord_movement", 18, "uniform_stretching");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_min_max_thickness", 2, "NO");
    NC4ERR
    dattr = 1.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_min_thickness", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 6.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_max_thickness_factor", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_dzdk_positive", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_freq_filtered_thickness", 2, "NO");
    NC4ERR
    dattr = 5.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_thickness_filter_timescale", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_highFreqThick_restore", 2, "NO");
    NC4ERR
    dattr = 30.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_highFreqThick_restore_time", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_highFreqThick_del2", 2, "NO");
    NC4ERR
    dattr = 100.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_highFreqThick_del2", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_alter_ICs_for_pbcs", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_pbc_alteration_type", 9, "full_cell");
    NC4ERR
    dattr = 0.1;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_min_pbc_fraction", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_hmix_scaleWithMesh", 3, "YES");
    NC4ERR
    dattr = -1.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_maxMeshDensity", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_apvm_scale_factor", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_mom_del2", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_tracer_del2", 2, "NO");
    NC4ERR
    dattr = 10.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_mom_del2", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 10.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_tracer_del2", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_mom_del4", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_tracer_del4", 2, "NO");
    NC4ERR
    dattr = 3200000000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_mom_del4", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_mom_del4_div_factor", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_tracer_del4", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_Leith_del2", 2, "NO");
    NC4ERR
    dattr = 1.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_Leith_parameter", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 15000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_Leith_dx", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 2500.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_Leith_visc2_max", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_standardGM", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_Redi_surface_layer_tapering", 2, "NO");
    NC4ERR
    dattr = 0.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_Redi_surface_layer_tapering_extent", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_Redi_bottom_layer_tapering", 2, "NO");
    NC4ERR
    dattr = 0.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_Redi_bottom_layer_tapering_depth", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_GM_Bolus_kappa_function", 8, "constant");
    NC4ERR
    dattr = 1800.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_standardGM_tracer_kappa", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_GM_Bolus_kappa_min", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 600.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_GM_Bolus_kappa_max", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 20000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_GM_Bolus_cell_size_min", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 30000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_GM_Bolus_cell_size_max", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_Redi_kappa", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.3;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_gravWaveSpeed_trunc", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.01;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_max_relative_slope", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_mom_del2_tensor", 2, "NO");
    NC4ERR
    dattr = 10.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_mom_del2_tensor", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_mom_del4_tensor", 2, "NO");
    NC4ERR
    dattr = 50000000000000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_mom_del4_tensor", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_Rayleigh_friction", 2, "NO");
    NC4ERR
    dattr = 0.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_Rayleigh_damping_coeff", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_Rayleigh_bottom_friction", 2, "NO");
    NC4ERR
    dattr = 0.0001;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_Rayleigh_bottom_damping_coeff", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_cvmix", 3, "YES");
    NC4ERR
    dattr = 1.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_prandtl_number", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_cvmix_background", 3, "YES");
    NC4ERR
    dattr = 0.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_background_diffusion", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.0001;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_background_viscosity", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_cvmix_convection", 3, "YES");
    NC4ERR
    dattr = 1.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_convective_diffusion", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_convective_viscosity", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_cvmix_convective_basedOnBVF", 3, "YES");
    NC4ERR
    dattr = 0.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_convective_triggerBVF", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_cvmix_shear", 3, "YES");
    NC4ERR
    iattr = 2;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_num_ri_smooth_loops", NC_INT, 1, &iattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_cvmix_use_BLD_smoothing", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_cvmix_shear_mixing_scheme", 3, "KPP");
    NC4ERR
    dattr = 0.005;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_shear_PP_nu_zero", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 5.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_shear_PP_alpha", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 2.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_shear_PP_exp", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.005;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_shear_KPP_nu_zero", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.7;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_shear_KPP_Ri_zero", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 3.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_shear_KPP_exp", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_cvmix_tidal_mixing", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_cvmix_double_diffusion", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_cvmix_kpp", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_cvmix_fixed_boundary_layer", 2, "NO");
    NC4ERR
    dattr = 30.;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_cvmix_kpp_boundary_layer_depth", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.25;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_kpp_criticalBulkRichardsonNumber", NC_DOUBLE,
                      1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_cvmix_kpp_matching", 12, "SimpleShapes");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_cvmix_kpp_EkmanOBL", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_cvmix_kpp_MonObOBL", 2, "NO");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_cvmix_kpp_interpolationOMLType", 9, "quadratic");
    NC4ERR
    dattr = 0.1;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_cvmix_kpp_surface_layer_extent", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 5.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_kpp_surface_layer_averaging", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = 10.;
    err   = nc_put_att (ncid, NC_GLOBAL, "configure_cvmix_kpp_minimum_OBL_under_sea_ice", NC_DOUBLE,
                      1, &dattr);
    NC4ERR
    dattr = 100.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_kpp_stop_OBL_search", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_cvmix_kpp_use_enhanced_diff", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_cvmix_kpp_nonlocal_with_implicit_mix", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_const_visc", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_const_diff", 2, "NO");
    NC4ERR
    dattr = 0.0001;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_vert_visc", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1.e-05;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_vert_diff", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_rich_visc", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_rich_diff", 2, "NO");
    NC4ERR
    dattr = 0.0001;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_bkrd_vert_visc", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1.e-05;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_bkrd_vert_diff", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.005;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_rich_mix", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_convective_visc", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_convective_diff", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_tanh_visc", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_tanh_diff", 2, "NO");
    NC4ERR
    dattr = 0.25;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_max_visc_tanh", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.0001;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_min_visc_tanh", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.025;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_max_diff_tanh", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1.e-05;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_min_diff_tanh", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -100.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_zMid_tanh", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 100.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_zWidth_tanh", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_bulk_wind_stress", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_bulk_thickness_flux", 3, "YES");
    NC4ERR
    dattr = 0.001;
    err = nc_put_att (ncid, NC_GLOBAL, "config_flux_attenuation_coefficient", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 10.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_flux_attenuation_coefficient_runoff", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = 86400.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_ssh_grad_relax_timescale", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_remove_AIS_coupler_runoff", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_sw_absorption_type", 6, "jerlov");
    NC4ERR
    iattr = 3;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_jerlov_water_type", NC_INT, 1, &iattr);
    NC4ERR
    dattr = 1.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_surface_buoyancy_depth", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_frazil_ice_formation", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_frazil_in_open_ocean", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_frazil_under_land_ice", 3, "YES");
    NC4ERR
    dattr = 333700.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_frazil_heat_of_fusion", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_frazil_ice_density", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.1;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_frazil_fractional_thickness_limit", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = 3996.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_specific_heat_sea_water", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 100.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_frazil_maximum_depth", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 4.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_frazil_sea_ice_reference_salinity", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = 0.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_frazil_land_ice_reference_salinity", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = 0.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_frazil_maximum_freezing_temperature", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_frazil_use_surface_pressure", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_land_ice_flux_mode", 13, "pressure_only");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_land_ice_flux_formulation", 7, "Jenkins");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_land_ice_flux_useHollandJenkinsAdvDiff", 2, "NO");
    NC4ERR
    dattr = 10.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_land_ice_flux_attenuation_coefficient", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = 10.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_land_ice_flux_boundaryLayerThickness", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = 0.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_land_ice_flux_boundaryLayerNeighborWeight",
                      NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 2009.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_land_ice_flux_cp_ice", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 918.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_land_ice_flux_rho_ice", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.0025;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_land_ice_flux_topDragCoeff", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.0001;
    err = nc_put_att (ncid, NC_GLOBAL, "config_land_ice_flux_ISOMIP_gammaT", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.05;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_land_ice_flux_rms_tidal_velocity", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = 0.011;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_land_ice_flux_jenkins_heat_transfer_coefficient",
                      NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.00031;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_land_ice_flux_jenkins_salt_transfer_coefficient",
                      NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_vert_tracer_adv", 7, "stencil");
    NC4ERR
    iattr = 3;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_vert_tracer_adv_order", NC_INT, 1, &iattr);
    NC4ERR
    iattr = 3;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_horiz_tracer_adv_order", NC_INT, 1, &iattr);
    NC4ERR
    dattr = 0.25;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_coef_3rd_order", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_monotonic", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_implicit_bottom_drag", 3, "YES");
    NC4ERR
    dattr = 0.001;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_implicit_bottom_drag_coeff", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_explicit_bottom_drag", 2, "NO");
    NC4ERR
    dattr = 0.001;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_explicit_bottom_drag_coeff", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1026.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_density0", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_pressure_gradient_type", 16, "Jacobian_from_TS");
    NC4ERR
    dattr = 0.5;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_common_level_weight", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_eos_type", 2, "jm");
    NC4ERR
    dattr = -1.8;
    err = nc_put_att (ncid, NC_GLOBAL, "config_open_ocean_freezing_temperature_coeff_0", NC_DOUBLE,
                      1, &dattr);
    NC4ERR
    dattr = 0.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_open_ocean_freezing_temperature_coeff_S", NC_DOUBLE,
                      1, &dattr);
    NC4ERR
    dattr = 0.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_open_ocean_freezing_temperature_coeff_p", NC_DOUBLE,
                      1, &dattr);
    NC4ERR
    dattr = 0.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_open_ocean_freezing_temperature_coeff_pS", NC_DOUBLE,
                      1, &dattr);
    NC4ERR
    dattr = 0.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_open_ocean_freezing_temperature_reference_pressure",
                      NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.0622;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_land_ice_cavity_freezing_temperature_coeff_0",
                      NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -0.0563;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_land_ice_cavity_freezing_temperature_coeff_S",
                      NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -7.43e-08;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_land_ice_cavity_freezing_temperature_coeff_p",
                      NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -1.74e-10;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_land_ice_cavity_freezing_temperature_coeff_pS",
                      NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.;
    err   = nc_put_att (ncid, NC_GLOBAL,
                      "config_land_ice_cavity_freezing_temperature_reference_pressure", NC_DOUBLE,
                      1, &dattr);
    NC4ERR
    dattr = 0.2;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_eos_linear_alpha", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.8;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_eos_linear_beta", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 5.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_eos_linear_Tref", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 35.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_eos_linear_Sref", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_eos_linear_densityref", NC_DOUBLE, 1, &dattr);
    NC4ERR
    iattr = 2;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_n_ts_iter", NC_INT, 1, &iattr);
    NC4ERR
    iattr = 1;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_n_bcl_iter_beg", NC_INT, 1, &iattr);
    NC4ERR
    iattr = 2;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_n_bcl_iter_mid", NC_INT, 1, &iattr);
    NC4ERR
    iattr = 2;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_n_bcl_iter_end", NC_INT, 1, &iattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_btr_dt", 13, "0000_00:00:12");
    NC4ERR
    iattr = 2;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_n_btr_cor_iter", NC_INT, 1, &iattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_vel_correction", 3, "YES");
    NC4ERR
    iattr = 2;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_btr_subcycle_loop_factor", NC_INT, 1, &iattr);
    NC4ERR
    dattr = 0.5;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_btr_gam1_velWt1", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_btr_gam2_SSHWt1", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_btr_gam3_velWt2", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_btr_solve_SSH2", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_conduct_tests", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_test_tensors", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_tensor_test_function", 11, "sph_uCosCos");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_disable_redi_k33", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_disable_redi_horizontal_term1", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_disable_redi_horizontal_term2", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_disable_redi_horizontal_term3", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_check_zlevel_consistency", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_check_ssh_consistency", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_filter_btr_mode", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_prescribe_velocity", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_prescribe_thickness", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_include_KE_vertex", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_check_tracer_monotonicity", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_compute_active_tracer_budgets", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_disable_thick_all_tend", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_disable_thick_hadv", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_disable_thick_vadv", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_disable_thick_sflux", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_disable_vel_all_tend", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_disable_vel_coriolis", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_disable_vel_pgrad", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_disable_vel_hmix", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_disable_vel_surface_stress", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_disable_vel_explicit_bottom_drag", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_disable_vel_vmix", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_disable_vel_vadv", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_disable_tr_all_tend", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_disable_tr_adv", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_disable_tr_hmix", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_disable_tr_vmix", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_disable_tr_sflux", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_disable_tr_nonlocalflux", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_read_nearest_restart", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_rx1_constraint", 2, "NO");
    NC4ERR
    iattr = 20;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_rx1_outer_iter_count", NC_INT, 1, &iattr);
    NC4ERR
    iattr = 10;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_rx1_inner_iter_count", NC_INT, 1, &iattr);
    NC4ERR
    dattr = 0.1;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_rx1_init_inner_weight", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 5.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_rx1_max", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_rx1_horiz_smooth_weight", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_rx1_vert_smooth_weight", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.1;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_rx1_slope_weight", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_rx1_zstar_weight", NC_DOUBLE, 1, &dattr);
    NC4ERR
    iattr = 20;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_rx1_horiz_smooth_open_ocean_cells", NC_INT, 1, &iattr);
    NC4ERR
    iattr = 3;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_rx1_min_levels", NC_INT, 1, &iattr);
    NC4ERR
    dattr = 1.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_rx1_min_layer_thickness", NC_DOUBLE, 1, &dattr);
    NC4ERR
    iattr = 20;
    err = nc_put_att (ncid, NC_GLOBAL, "config_baroclinic_channel_vert_levels", NC_INT, 1, &iattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_baroclinic_channel_use_distances", 2, "NO");
    NC4ERR
    dattr = 13.1000003814697;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_baroclinic_channel_surface_temperature", NC_DOUBLE,
                      1, &dattr);
    NC4ERR
    dattr = 10.1000003814697;
    err = nc_put_att (ncid, NC_GLOBAL, "config_baroclinic_channel_bottom_temperature", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = 1.20000004768372;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_baroclinic_channel_temperature_difference",
                      NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.0799999982118607;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_baroclinic_channel_gradient_width_frac", NC_DOUBLE,
                      1, &dattr);
    NC4ERR
    dattr = 40000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_baroclinic_channel_gradient_width_dist", NC_DOUBLE,
                      1, &dattr);
    NC4ERR
    dattr = 1000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_baroclinic_channel_bottom_depth", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = 35.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_baroclinic_channel_salinity", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -0.000119999996968545;
    err = nc_put_att (ncid, NC_GLOBAL, "config_baroclinic_channel_coriolis_parameter", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    iattr = 20;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_lock_exchange_vert_levels", NC_INT, 1, &iattr);
    NC4ERR
    dattr = 20.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_lock_exchange_bottom_depth", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 5.;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_lock_exchange_cold_temperature", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 30.;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_lock_exchange_warm_temperature", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_lock_exchange_direction", 1, "y");
    NC4ERR
    dattr = 35.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_lock_exchange_salinity", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_lock_exchange_layer_type", 7, "z-level");
    NC4ERR
    dattr = 0.00999999977648258;
    err = nc_put_att (ncid, NC_GLOBAL, "config_lock_exchange_isopycnal_min_thickness", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    iattr = 20;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_internal_waves_vert_levels", NC_INT, 1, &iattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_internal_waves_use_distances", 2, "NO");
    NC4ERR
    dattr = 20.1000003814697;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_internal_waves_surface_temperature", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = 10.1000003814697;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_internal_waves_bottom_temperature", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = 2.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_internal_waves_temperature_difference", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = 0.330000013113022;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_internal_waves_amplitude_width_frac", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = 50000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_internal_waves_amplitude_width_dist", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = 500.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_internal_waves_bottom_depth", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 35.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_internal_waves_salinity", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_internal_waves_layer_type", 7, "z-level");
    NC4ERR
    dattr = 125.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_internal_waves_isopycnal_displacement", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    iattr = 100;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_overflow_vert_levels", NC_INT, 1, &iattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_overflow_use_distances", 2, "NO");
    NC4ERR
    dattr = 2000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_overflow_bottom_depth", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 500.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_overflow_ridge_depth", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 10.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_overflow_plug_temperature", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 20.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_overflow_domain_temperature", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 35.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_overflow_salinity", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.100000001490116;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_overflow_plug_width_frac", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.200000002980232;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_overflow_slope_center_frac", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.0500000007450581;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_overflow_slope_width_frac", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 20000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_overflow_plug_width_dist", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 40000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_overflow_slope_center_dist", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 7000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_overflow_slope_width_dist", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_overflow_layer_type", 7, "z-level");
    NC4ERR
    dattr = 0.00999999977648258;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_overflow_isopycnal_min_thickness", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = 15.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_global_ocean_minimum_depth", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_depth_file", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_depth_dimname", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_depth_varname", 4, "none");
    NC4ERR
    dattr = 1.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_global_ocean_depth_conversion_factor", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_temperature_file", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_salinity_file", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_tracer_nlat_dimname", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_tracer_nlon_dimname", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_tracer_ndepth_dimname", 4, "none");
    NC4ERR
    dattr = 1.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_global_ocean_tracer_depth_conversion_factor",
                      NC_DOUBLE, 1, &dattr);
    NC4ERR
    iattr = -1;
    err = nc_put_att (ncid, NC_GLOBAL, "config_global_ocean_tracer_vert_levels", NC_INT, 1, &iattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_temperature_varname", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_salinity_varname", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_tracer_latlon_degrees", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_tracer_lat_varname", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_tracer_lon_varname", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_tracer_depth_varname", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_tracer_method", 22,
                           "bilinear_interpolation");
    NC4ERR
    iattr = 0;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_global_ocean_smooth_TS_iterations", NC_INT, 1, &iattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_swData_file", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_swData_nlat_dimname", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_swData_nlon_dimname", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_swData_lat_varname", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_swData_lon_varname", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_swData_latlon_degrees", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_swData_method", 22,
                           "bilinear_interpolation");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_chlorophyll_varname", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_zenithAngle_varname", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_clearSky_varname", 4, "none");
    NC4ERR
    dattr = 4.99999987368938e-05;
    err = nc_put_att (ncid, NC_GLOBAL, "config_global_ocean_piston_velocity", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_global_ocean_interior_restore_rate", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_topography_file", 4, "none");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_topography_nlat_dimname", 4, "none");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_topography_nlon_dimname", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_topography_latlon_degrees", 3,
                           "YES");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_topography_lat_varname", 4, "none");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_topography_lon_varname", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_topography_varname", 4, "none");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_topography_has_ocean_frac", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_topography_ocean_frac_varname", 4,
                           "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_topography_method", 22,
                           "bilinear_interpolation");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_smooth_topography", 3, "YES");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_deepen_critical_passages", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_depress_by_land_ice", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_land_ice_topo_file", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_land_ice_topo_nlat_dimname", 4,
                           "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_land_ice_topo_nlon_dimname", 4,
                           "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_land_ice_topo_latlon_degrees", 3,
                           "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_land_ice_topo_lat_varname", 4,
                           "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_land_ice_topo_lon_varname", 4,
                           "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_land_ice_topo_thickness_varname",
                           4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_land_ice_topo_draft_varname", 4,
                           "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_land_ice_topo_ice_frac_varname", 4,
                           "none");
    NC4ERR
    ...
    err   = nc_put_att (ncid, NC_GLOBAL, "config_global_ocean_constant_land_ice_cavity_temperature",
                      NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_cull_inland_seas", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_windstress_file", 4, "none");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_windstress_nlat_dimname", 4, "none");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_windstress_nlon_dimname", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_windstress_latlon_degrees", 3,
                           "YES");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_windstress_lat_varname", 4, "none");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_windstress_lon_varname", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_windstress_zonal_varname", 4,
                           "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_windstress_meridional_varname", 4,
                           "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_windstress_method", 22,
                           "bilinear_interpolation");
    NC4ERR
    dattr = 1.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_global_ocean_windstress_conversion_factor",
                      NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_ecosys_file", 7, "unknown");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_ecosys_forcing_file", 7, "unknown");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_ecosys_nlat_dimname", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_ecosys_nlon_dimname", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_ecosys_ndepth_dimname", 4, "none");
    NC4ERR
    dattr = 1.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_global_ocean_ecosys_depth_conversion_factor",
                      NC_DOUBLE, 1, &dattr);
    NC4ERR
    iattr = -1;
    err = nc_put_att (ncid, NC_GLOBAL, "config_global_ocean_ecosys_vert_levels", NC_INT, 1, &iattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_ecosys_lat_varname", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_ecosys_lon_varname", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_ecosys_depth_varname", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_ecosys_latlon_degrees", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_ecosys_method", 22,
                           "bilinear_interpolation");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_global_ocean_ecosys_forcing_time_dimname", 4,
                           "none");
    NC4ERR
    iattr = 0;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_global_ocean_smooth_ecosys_iterations", NC_INT, 1,
                      &iattr);
    NC4ERR
    iattr = 100;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_WSwSBF_vert_levels", NC_INT, 1, &iattr);
    NC4ERR
    dattr = 15.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_WSwSBF_surface_temperature", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = 35.;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_cvmix_WSwSBF_surface_salinity", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 15.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_WSwSBF_surface_restoring_temperature",
                      NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 35.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_WSwSBF_surface_restoring_salinity", NC_DOUBLE,
                      1, &dattr);
    NC4ERR
    dattr = 3.99999998990097e-06;
    err = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_WSwSBF_temperature_piston_velocity", NC_DOUBLE,
                      1, &dattr);
    NC4ERR
    dattr = 3.99999998990097e-06;
    err = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_WSwSBF_salinity_piston_velocity", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = 0.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_WSwSBF_sensible_heat_flux", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = 0.;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_cvmix_WSwSBF_latent_heat_flux", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_WSwSBF_shortwave_heat_flux", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = 0.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_WSwSBF_rain_flux", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_cvmix_WSwSBF_evaporation_flux", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 9.99999997475243e-07;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_WSwSBF_interior_temperature_restoring_rate",
                      NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 9.99999997475243e-07;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_WSwSBF_interior_salinity_restoring_rate",
                      NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.00999999977648258;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_WSwSBF_temperature_gradient", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = 0.;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_cvmix_WSwSBF_salinity_gradient", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_WSwSBF_temperature_gradient_mixed_layer",
                      NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_WSwSBF_salinity_gradient_mixed_layer",
                      NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_WSwSBF_mixed_layer_depth_temperature",
                      NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_WSwSBF_mixed_layer_depth_salinity", NC_DOUBLE,
                      1, &dattr);
    NC4ERR
    dattr = 0.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_WSwSBF_mixed_layer_temperature_change",
                      NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_WSwSBF_mixed_layer_salinity_change", NC_DOUBLE,
                      1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_cvmix_WSwSBF_vertical_grid", 7, "uniform");
    NC4ERR
    dattr = 400.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_WSwSBF_bottom_depth", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.100000001490116;
    err = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_WSwSBF_max_windstress", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 9.99999974737875e-05;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_cvmix_WSwSBF_coriolis_parameter", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    iattr = 100;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_vert_levels", NC_INT, 1, &iattr);
    NC4ERR
    dattr = 4000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_main_channel_depth", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -50.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_north_wall_lat", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -70.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_south_wall_lat", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_iso_ridge_flag", 3, "YES");
    NC4ERR
    dattr = 180.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_ridge_center_lon", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 2000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_ridge_height", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 2000000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_ridge_width", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_iso_plateau_flag", 3, "YES");
    NC4ERR
    dattr = 300.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_plateau_center_lon", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -58.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_plateau_center_lat", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 2000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_plateau_height", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 200000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_plateau_radius", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1000000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_plateau_slope_width", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_iso_shelf_flag", 3, "YES");
    NC4ERR
    dattr = 500.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_shelf_depth", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 120000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_shelf_width", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_iso_cont_slope_flag", 3, "YES");
    NC4ERR
    dattr = 0.00999999977648258;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_max_cont_slope", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_iso_embayment_flag", 3, "YES");
    NC4ERR
    dattr = 60.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_embayment_center_lon", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -71.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_embayment_center_lat", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 500000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_embayment_radius", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 2000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_embayment_depth", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_iso_depression_flag", 3, "YES");
    NC4ERR
    dattr = 60.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_depression_center_lon", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -72.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_depression_south_lat", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -65.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_depression_north_lat", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 480000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_depression_width", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 800.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_depression_depth", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 35.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_salinity", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.00999999977648258;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_wind_stress_max", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.200000002980232;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_acc_wind", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -0.0500000007450581;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_asf_wind", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -65.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_wind_trans", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -5.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_heat_flux_south", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 10.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_heat_flux_middle", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -5.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_heat_flux_north", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -70.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_heat_flux_lat_ss", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -65.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_heat_flux_lat_sm", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -53.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_heat_flux_lat_mn", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 60.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_region1_center_lon", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -75.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_region1_center_lat", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 150.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_region2_center_lon", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -71.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_region2_center_lat", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 240.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_region3_center_lon", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -71.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_region3_center_lat", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 330.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_region4_center_lon", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -71.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_region4_center_lat", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_iso_heat_flux_region1_flag", 2, "NO");
    NC4ERR
    dattr = -5.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_heat_flux_region1", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 300000.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_iso_heat_flux_region1_radius", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_iso_heat_flux_region2_flag", 2, "NO");
    NC4ERR
    dattr = -5.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_heat_flux_region2", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 240000.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_iso_heat_flux_region2_radius", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 5.80000014451798e-05;
    err = nc_put_att (ncid, NC_GLOBAL, "config_iso_surface_temperature_piston_velocity", NC_DOUBLE,
                      1, &dattr);
    NC4ERR
    dattr = 3.5;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_initial_temp_t1", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 4.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_initial_temp_t2", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1200.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_initial_temp_h0", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 500.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_initial_temp_h1", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 7.50000035623088e-05;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_initial_temp_mt", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -75.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_initial_temp_latS", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -50.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_initial_temp_latN", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 10.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_temperature_sponge_t1", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_temperature_sponge_h1", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 120000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_temperature_sponge_l1", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 10.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_iso_temperature_sponge_tau1", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_iso_temperature_restore_region1_flag", 3, "YES");
    NC4ERR
    dattr = -1.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_temperature_restore_t1", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 600000.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_iso_temperature_restore_lcx1", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 600000.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_iso_temperature_restore_lcy1", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_iso_temperature_restore_region2_flag", 3, "YES");
    NC4ERR
    dattr = -1.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_temperature_restore_t2", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 600000.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_iso_temperature_restore_lcx2", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 250000.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_iso_temperature_restore_lcy2", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_iso_temperature_restore_region3_flag", 3, "YES");
    NC4ERR
    dattr = -1.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_temperature_restore_t3", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 600000.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_iso_temperature_restore_lcx3", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 250000.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_iso_temperature_restore_lcy3", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_iso_temperature_restore_region4_flag", 3, "YES");
    NC4ERR
    dattr = -1.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_iso_temperature_restore_t4", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 600000.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_iso_temperature_restore_lcx4", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 250000.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_iso_temperature_restore_lcy4", NC_DOUBLE, 1, &dattr);
    NC4ERR
    iattr = 100;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_soma_vert_levels", NC_INT, 1, &iattr);
    NC4ERR
    dattr = 1250000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_soma_domain_width", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 35.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_soma_center_latitude", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_soma_center_longitude", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.100000001490116;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_soma_phi", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 2500.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_soma_bottom_depth", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -0.400000005960464;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_soma_shelf_width", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 100.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_soma_shelf_depth", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_soma_ref_density", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 4.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_soma_density_difference", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 300.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_soma_thermocline_depth", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.0500000007450581;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_soma_density_difference_linear", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 20.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_soma_surface_temperature", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 33.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_soma_surface_salinity", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_soma_use_surface_temp_restoring", 2, "NO");
    NC4ERR
    dattr = 7.5;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_soma_surface_temp_restoring_at_center_latitude",
                      NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.5;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_soma_surface_temp_restoring_latitude_gradient",
                      NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 9.99999974737875e-06;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_soma_restoring_temp_piston_vel", NC_DOUBLE, 1, &dattr);
    NC4ERR
    iattr = 100;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_ziso_vert_levels", NC_INT, 1, &iattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_ziso_add_easterly_wind_stress_ASF", 2, "NO");
    NC4ERR
    dattr = 800000.;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_ziso_wind_transition_position", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 600000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_ziso_antarctic_shelf_front_width", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = -0.0500000007450581;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_ziso_wind_stress_shelf_front_max", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_ziso_use_slopping_bathymetry", 2, "NO");
    NC4ERR
    dattr = 2000000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_ziso_meridional_extent", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1000000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_ziso_zonal_extent", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 2500.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_ziso_bottom_depth", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 500.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_ziso_shelf_depth", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 100000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_ziso_slope_half_width", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 500000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_ziso_slope_center_position", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -9.99999974737875e-05;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_ziso_reference_coriolis", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_ziso_coriolis_gradient", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.200000002980232;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_ziso_wind_stress_max", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 3.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_ziso_mean_restoring_temp", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 2.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_ziso_restoring_temp_dev_ta", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 2.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_ziso_restoring_temp_dev_tb", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 30.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_ziso_restoring_temp_tau", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1.89999991562217e-05;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_ziso_restoring_temp_piston_vel", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1250.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_ziso_restoring_temp_ze", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 80000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_ziso_restoring_sponge_l", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 6.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_ziso_initial_temp_t1", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 3.59999990463257;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_ziso_initial_temp_t2", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 300.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_ziso_initial_temp_h1", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 7.50000035623088e-05;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_ziso_initial_temp_mt", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_ziso_frazil_enable", 2, "NO");
    NC4ERR
    dattr = -3.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_ziso_frazil_temperature_anomaly", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    iattr = 20;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_sub_ice_shelf_2D_vert_levels", NC_INT, 1, &iattr);
    NC4ERR
    dattr = 2000.;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_sub_ice_shelf_2D_bottom_depth", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 25.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_sub_ice_shelf_2D_cavity_thickness", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = 500.;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_sub_ice_shelf_2D_slope_height", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 15000.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_sub_ice_shelf_2D_edge_width", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 30000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_sub_ice_shelf_2D_y1", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 60000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_sub_ice_shelf_2D_y2", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_sub_ice_shelf_2D_temperature", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 34.5;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_sub_ice_shelf_2D_surface_salinity", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = 34.7000007629395;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_sub_ice_shelf_2D_bottom_salinity", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    iattr = 100;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_periodic_planar_vert_levels", NC_INT, 1, &iattr);
    NC4ERR
    dattr = 2500.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_periodic_planar_bottom_depth", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_periodic_planar_velocity_strength", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    iattr = 100;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_ecosys_column_vert_levels", NC_INT, 1, &iattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_ecosys_column_vertical_grid", 14,
                           "100layerACMEv1");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_ecosys_column_TS_filename", 7, "unknown");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_ecosys_column_ecosys_filename", 7, "unknown");
    NC4ERR
    dattr = 6000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_ecosys_column_bottom_depth", NC_DOUBLE, 1, &dattr);
    NC4ERR
    iattr = 10;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_sea_mount_vert_levels", NC_INT, 1, &iattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_sea_mount_layer_type", 5, "sigma");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_sea_mount_stratification_type", 11,
                           "exponential");
    NC4ERR
    dattr = 1024.;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_sea_mount_density_coef_linear", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1028.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_sea_mount_density_coef_exp", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.100000001490116;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_sea_mount_density_gradient_linear", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = 3.;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_sea_mount_density_gradient_exp", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 4500.;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_sea_mount_density_depth_linear", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 500.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_sea_mount_density_depth_exp", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1028.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_sea_mount_density_ref", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 5.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_sea_mount_density_Tref", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.200000002980232;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_sea_mount_density_alpha", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 5000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_sea_mount_bottom_depth", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 4500.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_sea_mount_height", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 10000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_sea_mount_radius", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 40000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_sea_mount_width", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 35.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_sea_mount_salinity", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -9.99999974737875e-05;
    err = nc_put_att (ncid, NC_GLOBAL, "config_sea_mount_coriolis_parameter", NC_DOUBLE, 1, &dattr);
    NC4ERR
    iattr = 30;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_vert_levels", NC_INT, 1, &iattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_isomip_vertical_level_distribution", 8,
                           "constant");
    NC4ERR
    dattr = -900.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_bottom_depth", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -1.89999997615814;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_temperature", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 34.4000015258789;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_salinity", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -1.89999997615814;
    err = nc_put_att (ncid, NC_GLOBAL, "config_isomip_restoring_temperature", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1.20000004244503e-05;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_temperature_piston_velocity", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = 34.4000015258789;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_restoring_salinity", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1.20000004244503e-05;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_salinity_piston_velocity", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = -0.00014000000373926;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_coriolis_parameter", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_southern_boundary", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1000000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_northern_boundary", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_western_boundary", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 500000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_eastern_boundary", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 0.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_y1", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -700.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_z1", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_ice_fraction1", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 400000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_y2", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -200.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_z2", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_ice_fraction2", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1000000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_y3", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -200.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_z3", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_ice_fraction3", NC_DOUBLE, 1, &dattr);
    NC4ERR
    iattr = 36;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_plus_vert_levels", NC_INT, 1, &iattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_isomip_plus_vertical_level_distribution", 8,
                           "constant");
    NC4ERR
    dattr = -720.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_isomip_plus_max_bottom_depth", NC_DOUBLE, 1, &dattr);
    NC4ERR
    iattr = 3;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_plus_minimum_levels", NC_INT, 1, &iattr);
    NC4ERR
    dattr = 10.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_plus_min_column_thickness", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = 0.5;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_isomip_plus_min_ocean_fraction", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_isomip_plus_topography_file", 27,
                           "input_geometry_processed.nc");
    NC4ERR
    dattr = -1.89999997615814;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_plus_init_top_temp", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -1.89999997615814;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_plus_init_bot_temp", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 33.7999992370605;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_plus_init_top_sal", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 34.5;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_plus_init_bot_sal", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -1.89999997615814;
    err = nc_put_att (ncid, NC_GLOBAL, "config_isomip_plus_restore_top_temp", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1.;
    err = nc_put_att (ncid, NC_GLOBAL, "config_isomip_plus_restore_bot_temp", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 33.7999992370605;
    err = nc_put_att (ncid, NC_GLOBAL, "config_isomip_plus_restore_top_sal", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 34.7000007629395;
    err = nc_put_att (ncid, NC_GLOBAL, "config_isomip_plus_restore_bot_sal", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 10.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_plus_restore_rate", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 200.;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_isomip_plus_restore_evap_rate", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 790000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_plus_restore_xMin", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 800000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_isomip_plus_restore_xMax", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -0.000140999996801838;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_isomip_plus_coriolis_parameter", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1026.;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_isomip_plus_effective_density", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_activeTracers", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_activeTracers_surface_bulk_forcing", 3,
                           "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_activeTracers_surface_restoring", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_activeTracers_interior_restoring", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_activeTracers_exponential_decay", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_activeTracers_idealAge_forcing", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_activeTracers_ttd_forcing", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_surface_salinity_monthly_restoring", 3,
                           "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL,
    ...
    NC4ERR
    dattr = 1.585e-06;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_salinity_restoring_constant_piston_velocity",
                      NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 100;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_salinity_restoring_max_difference", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_salinity_restoring_under_sea_ice", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_debugTracers", 2, "NO");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_use_debugTracers_surface_bulk_forcing", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_debugTracers_surface_restoring", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_debugTracers_interior_restoring", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_debugTracers_exponential_decay", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_debugTracers_idealAge_forcing", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_debugTracers_ttd_forcing", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_ecosysTracers", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_ecosys_atm_co2_option", 8, "constant");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_ecosys_atm_alt_co2_option", 8, "constant");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_ecosys_atm_alt_co2_use_eco", 2, "NO");
    NC4ERR
    dattr = 379.;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_ecosys_atm_co2_constant_value", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_use_ecosysTracers_surface_bulk_forcing", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_ecosysTracers_surface_restoring", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_ecosysTracers_interior_restoring", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_ecosysTracers_exponential_decay", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_ecosysTracers_idealAge_forcing", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_ecosysTracers_ttd_forcing", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_ecosysTracers_surface_value", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_ecosysTracers_sea_ice_coupling", 2, "NO");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_ecosysTracers_diagnostic_fields_level1", 2, "NO");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_ecosysTracers_diagnostic_fields_level2", 2, "NO");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_ecosysTracers_diagnostic_fields_level3", 2, "NO");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_ecosysTracers_diagnostic_fields_level4", 2, "NO");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_ecosysTracers_diagnostic_fields_level5", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_DMSTracers", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_DMSTracers_surface_bulk_forcing", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_DMSTracers_surface_restoring", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_DMSTracers_interior_restoring", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_DMSTracers_exponential_decay", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_DMSTracers_idealAge_forcing", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_DMSTracers_ttd_forcing", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_DMSTracers_surface_value", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_DMSTracers_sea_ice_coupling", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_MacroMoleculesTracers", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_MacroMoleculesTracers_surface_bulk_forcing",
                           2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_MacroMoleculesTracers_surface_restoring", 2,
                           "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_MacroMoleculesTracers_interior_restoring",
                           2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_MacroMoleculesTracers_exponential_decay", 2,
                           "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_MacroMoleculesTracers_idealAge_forcing", 2,
                           "NO");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_use_MacroMoleculesTracers_ttd_forcing", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_MacroMoleculesTracers_surface_value", 2,
                           "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_use_MacroMoleculesTracers_sea_ice_coupling", 2,
                           "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_globalStats_enable", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_globalStats_compute_interval", 15,
                           "output_interval");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_globalStats_compute_on_startup", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_globalStats_write_on_startup", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_globalStats_text_file", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_globalStats_directory", 16,
                           "analysis_members");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_globalStats_output_stream", 17,
                           "globalStatsOutput");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_AM_surfaceAreaWeightedAverages_enable", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL,
    ...
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_AM_surfaceAreaWeightedAverages_compute_interval",
                         19, "0000-00-00_01:00:00");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_surfaceAreaWeightedAverages_output_stream",
                           33, "surfaceAreaWeightedAveragesOutput");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_waterMassCensus_enable", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_waterMassCensus_compute_interval", 19,
                           "0000-00-00_01:00:00");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_waterMassCensus_output_stream", 21,
                           "waterMassCensusOutput");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_AM_waterMassCensus_compute_on_startup", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_waterMassCensus_write_on_startup", 2, "NO");
    NC4ERR
    dattr = -2.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_AM_waterMassCensus_minTemperature", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = 30.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_AM_waterMassCensus_maxTemperature", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = 32.;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_AM_waterMassCensus_minSalinity", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 37.;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_AM_waterMassCensus_maxSalinity", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_waterMassCensus_compute_predefined_regions",
                           3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_waterMassCensus_region_group", 0, "");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_AM_layerVolumeWeightedAverage_enable", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_layerVolumeWeightedAverage_compute_interval",
                           19, "0000-00-00_01:00:00");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL,
                           "config_AM_layerVolumeWeightedAverage_compute_on_startup", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_layerVolumeWeightedAverage_write_on_startup",
                           2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_layerVolumeWeightedAverage_output_stream",
                           32, "layerVolumeWeightedAverageOutput");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_zonalMean_enable", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_zonalMean_compute_on_startup", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_zonalMean_write_on_startup", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_zonalMean_compute_interval", 19,
                           "0000-00-00_01:00:00");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_zonalMean_output_stream", 15,
                           "zonalMeanOutput");
    NC4ERR
    iattr = 180;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_AM_zonalMean_num_bins", NC_INT, 1, &iattr);
    NC4ERR
    dattr = -1.e+34;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_AM_zonalMean_min_bin", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -1.e+34;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_AM_zonalMean_max_bin", NC_DOUBLE, 1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_okuboWeiss_enable", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_okuboWeiss_compute_on_startup", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_okuboWeiss_write_on_startup", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_okuboWeiss_compute_interval", 19,
                           "0000-00-00_01:00:00");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_okuboWeiss_output_stream", 16,
                           "okuboWeissOutput");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_AM_okuboWeiss_directory", 16, "analysis_members");
    NC4ERR
    dattr = -0.2;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_AM_okuboWeiss_threshold_value", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1.e-10;
    err = nc_put_att (ncid, NC_GLOBAL, "config_AM_okuboWeiss_normalization", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 1.e-10;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_AM_okuboWeiss_lambda2_normalization", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_okuboWeiss_use_lat_lon_coords", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_okuboWeiss_compute_eddy_census", 3, "YES");
    NC4ERR
    iattr = 20;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_AM_okuboWeiss_eddy_min_cells", NC_INT, 1, &iattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_meridionalHeatTransport_enable", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_meridionalHeatTransport_compute_interval",
                           19, "0000-00-00_01:00:00");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_meridionalHeatTransport_compute_on_startup",
                           3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_meridionalHeatTransport_write_on_startup", 2,
                           "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_meridionalHeatTransport_output_stream", 29,
                           "meridionalHeatTransportOutput");
    NC4ERR
    iattr = 180;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_AM_meridionalHeatTransport_num_bins", NC_INT, 1,
                      &iattr);
    NC4ERR
    dattr = -1.e+34;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_AM_meridionalHeatTransport_min_bin", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = -1.e+34;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_AM_meridionalHeatTransport_max_bin", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_AM_meridionalHeatTransport_region_group", 0, "");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_testComputeInterval_enable", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_testComputeInterval_compute_interval", 17,
                           "00-00-01_00:00:00");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_testComputeInterval_compute_on_startup", 3,
                           "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_testComputeInterval_write_on_startup", 2,
                           "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_testComputeInterval_output_stream", 25,
                           "testComputeIntervalOutput");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_highFrequencyOutput_enable", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_highFrequencyOutput_compute_interval", 15,
                           "output_interval");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_highFrequencyOutput_output_stream", 19,
                           "highFrequencyOutput");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_highFrequencyOutput_compute_on_startup", 2,
                           "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_highFrequencyOutput_write_on_startup", 2,
                           "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeFilters_enable", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeFilters_compute_interval", 2, "dt");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeFilters_output_stream", 17,
                           "timeFiltersOutput");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeFilters_restart_stream", 18,
                           "timeFiltersRestart");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeFilters_compute_on_startup", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeFilters_write_on_startup", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeFilters_initialize_filters", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeFilters_tau", 11, "90_00:00:00");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeFilters_compute_cell_centered_values", 3,
                           "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_lagrPartTrack_enable", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_lagrPartTrack_compute_interval", 2, "dt");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_lagrPartTrack_compute_on_startup", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_lagrPartTrack_output_stream", 19,
                           "lagrPartTrackOutput");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_lagrPartTrack_restart_stream", 20,
                           "lagrPartTrackRestart");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_lagrPartTrack_input_stream", 18,
                           "lagrPartTrackInput");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_lagrPartTrack_write_on_startup", 2, "NO");
    NC4ERR
    iattr = 0;
    err = nc_put_att (ncid, NC_GLOBAL, "config_AM_lagrPartTrack_filter_number", NC_INT, 1, &iattr);
    NC4ERR
    iattr = 2;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_AM_lagrPartTrack_timeIntegration", NC_INT, 1, &iattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_lagrPartTrack_reset_criteria", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_lagrPartTrack_reset_global_timestamp", 13,
                           "0000_00:00:00");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_lagrPartTrack_region_stream", 20,
                           "lagrPartTrackRegions");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_lagrPartTrack_reset_if_outside_region", 2,
                           "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_lagrPartTrack_reset_if_inside_region", 2,
                           "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_eliassenPalm_enable", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_eliassenPalm_compute_interval", 15,
                           "output_interval");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_eliassenPalm_output_stream", 18,
                           "eliassenPalmOutput");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_eliassenPalm_restart_stream", 19,
                           "eliassenPalmRestart");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_eliassenPalm_compute_on_startup", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_eliassenPalm_write_on_startup", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_eliassenPalm_debug", 2, "NO");
    NC4ERR
    iattr = 45;
    err = nc_put_att (ncid, NC_GLOBAL, "config_AM_eliassenPalm_nBuoyancyLayers", NC_INT, 1, &iattr);
    NC4ERR
    dattr = 900.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_AM_eliassenPalm_rhomin_buoycoor", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    dattr = 1080.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_AM_eliassenPalm_rhomax_buoycoor", NC_DOUBLE, 1,
                      &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_mixedLayerDepths_enable", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_mixedLayerDepths_compute_interval", 19,
                           "0000-00-00_01:00:00");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_mixedLayerDepths_output_stream", 22,
                           "mixedLayerDepthsOutput");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_mixedLayerDepths_write_on_startup", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_mixedLayerDepths_compute_on_startup", 3,
                           "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_mixedLayerDepths_Tthreshold", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_mixedLayerDepths_Dthreshold", 3, "YES");
    NC4ERR
    dattr = 0.2;
    err = nc_put_att (ncid, NC_GLOBAL, "config_AM_mixedLayerDepths_crit_temp_threshold", NC_DOUBLE,
                      1, &dattr);
    NC4ERR
    dattr = 0.03;
    err = nc_put_att (ncid, NC_GLOBAL, "config_AM_mixedLayerDepths_crit_dens_threshold", NC_DOUBLE,
                      1, &dattr);
    NC4ERR
    dattr = 100000.;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_AM_mixedLayerDepths_reference_pressure", NC_DOUBLE,
                      1, &dattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_mixedLayerDepths_Tgradient", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_mixedLayerDepths_Dgradient", 2, "NO");
    NC4ERR
    dattr = 5.e-07;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_AM_mixedLayerDepths_temp_gradient_threshold",
                      NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = 5.e-08;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_AM_mixedLayerDepths_den_gradient_threshold",
                      NC_DOUBLE, 1, &dattr);
    NC4ERR
    iattr = 1;
    err =
        nc_put_att (ncid, NC_GLOBAL, "config_AM_mixedLayerDepths_interp_method", NC_INT, 1, &iattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_enable", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_compute_on_startup", 2,
                           "NO");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_write_on_startup", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_compute_interval", 15,
                           "output_interval");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_output_stream", 24,
                           "regionalStatsDailyOutput");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_restart_stream", 18,
                           "regionalMasksInput");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_input_stream", 18,
                           "regionalMasksInput");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_operation", 3, "avg");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_region_type", 4, "cell");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_region_group", 3, "all");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_1d_weighting_function", 3,
                           "mul");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_2d_weighting_function", 3,
                           "mul");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_1d_weighting_field", 8,
                           "areaCell");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_2d_weighting_field", 10,
                           "volumeCell");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_vertical_mask", 8,
                           "cellMask");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsDaily_vertical_dimension", 11,
                           "nVertLevels");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_enable", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_compute_on_startup", 2,
                           "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_write_on_startup", 2,
                           "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_compute_interval", 15,
                           "output_interval");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_output_stream", 25,
                           "regionalStatsWeeklyOutput");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_restart_stream", 18,
                           "regionalMasksInput");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_input_stream", 18,
                           "regionalMasksInput");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_operation", 3, "avg");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_region_type", 4, "cell");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_region_group", 3, "all");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_1d_weighting_function",
                           3, "mul");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_2d_weighting_function",
                           3, "mul");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_1d_weighting_field", 8,
                           "areaCell");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_2d_weighting_field", 10,
                           "volumeCell");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_vertical_mask", 8,
                           "cellMask");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsWeekly_vertical_dimension", 11,
                           "nVertLevels");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_enable", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_compute_on_startup", 2,
                           "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_write_on_startup", 2,
                           "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_compute_interval", 15,
                           "output_interval");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_output_stream", 26,
                           "regionalStatsMonthlyOutput");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_restart_stream", 18,
                           "regionalMasksInput");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_input_stream", 18,
                           "regionalMasksInput");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_operation", 3, "avg");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_region_type", 4, "cell");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_region_group", 3, "all");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_1d_weighting_function",
                           3, "mul");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_2d_weighting_function",
                           3, "mul");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_1d_weighting_field", 8,
                           "areaCell");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_2d_weighting_field", 10,
                           "volumeCell");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_vertical_mask", 8,
                           "cellMask");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsMonthly_vertical_dimension", 11,
                           "nVertLevels");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_enable", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_compute_on_startup", 2,
                           "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_write_on_startup", 2,
                           "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_compute_interval", 15,
                           "output_interval");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_output_stream", 25,
                           "regionalStatsCustomOutput");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_restart_stream", 18,
                           "regionalMasksInput");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_input_stream", 18,
                           "regionalMasksInput");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_operation", 3, "avg");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_region_type", 4, "cell");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_region_group", 3, "all");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_1d_weighting_function",
                           3, "mul");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_2d_weighting_function",
                           3, "mul");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_1d_weighting_field", 8,
                           "areaCell");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_2d_weighting_field", 10,
                           "volumeCell");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_vertical_mask", 8,
                           "cellMask");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_regionalStatsCustom_vertical_dimension", 11,
                           "nVertLevels");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsDaily_enable", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsDaily_compute_on_startup", 2,
                           "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsDaily_write_on_startup", 2,
                           "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsDaily_compute_interval", 17,
                           "00-00-00_01:00:00");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsDaily_output_stream", 26,
                           "timeSeriesStatsDailyOutput");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsDaily_restart_stream", 4,
                           "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsDaily_operation", 3, "avg");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsDaily_reference_times", 12,
                           "initial_time");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsDaily_duration_intervals", 15,
                           "repeat_interval");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsDaily_repeat_intervals", 14,
                           "reset_interval");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsDaily_reset_intervals", 17,
                           "00-00-01_00:00:00");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsDaily_backward_output_offset",
                           17, "00-00-01_00:00:00");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsMonthly_enable", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsMonthly_compute_on_startup",
                           2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsMonthly_write_on_startup", 2,
                           "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsMonthly_compute_interval", 17,
                           "00-00-00_01:00:00");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsMonthly_output_stream", 28,
                           "timeSeriesStatsMonthlyOutput");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsMonthly_restart_stream", 4,
                           "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsMonthly_operation", 3, "avg");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsMonthly_reference_times", 12,
                           "initial_time");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsMonthly_duration_intervals",
                           15, "repeat_interval");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsMonthly_repeat_intervals", 14,
                           "reset_interval");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsMonthly_reset_intervals", 17,
                           "00-01-00_00:00:00");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsMonthly_backward_output_offset",
                         17, "00-01-00_00:00:00");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsClimatology_enable", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL,
                           "config_AM_timeSeriesStatsClimatology_compute_on_startup", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsClimatology_write_on_startup",
                           2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsClimatology_compute_interval",
                           17, "00-00-00_01:00:00");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsClimatology_output_stream",
                           32, "timeSeriesStatsClimatologyOutput");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsClimatology_restart_stream",
                           33, "timeSeriesStatsClimatologyRestart");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsClimatology_operation", 3,
                           "avg");
    NC4ERR
    err = nc_put_att_text (
    ...
    err = nc_put_att_text (ncid, NC_GLOBAL,
                           ...
                           "00-03-00_00:00:00");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsCustom_enable", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsCustom_compute_on_startup", 2,
                           "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsCustom_write_on_startup", 2,
                           "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsCustom_compute_interval", 17,
                           "00-00-00_01:00:00");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsCustom_output_stream", 27,
                           "timeSeriesStatsCustomOutput");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsCustom_restart_stream", 28,
                           "timeSeriesStatsCustomRestart");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsCustom_operation", 3, "avg");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsCustom_reference_times", 12,
                           "initial_time");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsCustom_duration_intervals",
                           15, "repeat_interval");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsCustom_repeat_intervals", 14,
                           "reset_interval");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsCustom_reset_intervals", 17,
                           "00-00-07_00:00:00");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_AM_timeSeriesStatsCustom_backward_output_offset",
                         17, "00-00-01_00:00:00");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_pointwiseStats_enable", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_pointwiseStats_compute_interval", 15,
                           "output_interval");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_pointwiseStats_output_stream", 20,
                           "pointwiseStatsOutput");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_AM_pointwiseStats_compute_on_startup", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_pointwiseStats_write_on_startup", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_debugDiagnostics_enable", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_debugDiagnostics_compute_interval", 2, "dt");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_debugDiagnostics_output_stream", 22,
                           "debugDiagnosticsOutput");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_debugDiagnostics_compute_on_startup", 3,
                           "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_debugDiagnostics_write_on_startup", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_debugDiagnostics_check_state", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_rpnCalculator_enable", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_rpnCalculator_compute_on_startup", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_rpnCalculator_write_on_startup", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_rpnCalculator_compute_interval", 19,
                           "0010-00-00_00:00:00");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_rpnCalculator_output_stream", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_rpnCalculator_variable_a", 14,
                           "layerThickness");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_rpnCalculator_variable_b", 8, "areaCell");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_rpnCalculator_variable_c", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_rpnCalculator_variable_d", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_rpnCalculator_variable_e", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_rpnCalculator_variable_f", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_rpnCalculator_variable_g", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_rpnCalculator_variable_h", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_rpnCalculator_expression_1", 5, "a b *");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_rpnCalculator_expression_2", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_rpnCalculator_expression_3", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_rpnCalculator_expression_4", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_rpnCalculator_output_name_1", 10,
                           "volumeCell");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_rpnCalculator_output_name_2", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_rpnCalculator_output_name_3", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_rpnCalculator_output_name_4", 4, "none");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_transectTransport_enable", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_transectTransport_compute_interval", 15,
                           "output_interval");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_transectTransport_output_stream", 23,
                           "transectTransportOutput");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_transectTransport_compute_on_startup", 3,
                           "YES");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_AM_transectTransport_write_on_startup", 2, "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_transectTransport_transect_group", 3, "all");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_eddyProductVariables_enable", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_eddyProductVariables_compute_interval", 19,
                           "0000-00-00_01:00:00");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_eddyProductVariables_output_stream", 26,
                           "eddyProductVariablesOutput");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_eddyProductVariables_compute_on_startup", 3,
                           "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_eddyProductVariables_write_on_startup", 2,
                           "NO");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_mocStreamfunction_enable", 3, "YES");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_mocStreamfunction_compute_interval", 19,
                           "0000-00-00_01:00:00");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_mocStreamfunction_output_stream", 23,
                           "mocStreamfunctionOutput");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_mocStreamfunction_compute_on_startup", 3,
                           "YES");
    NC4ERR
    err =
        nc_put_att_text (ncid, NC_GLOBAL, "config_AM_mocStreamfunction_write_on_startup", 2, "NO");
    NC4ERR
    dattr = -1.e+34;
    err = nc_put_att (ncid, NC_GLOBAL, "config_AM_mocStreamfunction_min_bin", NC_DOUBLE, 1, &dattr);
    NC4ERR
    dattr = -1.e+34;
    err = nc_put_att (ncid, NC_GLOBAL, "config_AM_mocStreamfunction_max_bin", NC_DOUBLE, 1, &dattr);
    NC4ERR
    iattr = 180;
    err   = nc_put_att (ncid, NC_GLOBAL, "config_AM_mocStreamfunction_num_bins", NC_INT, 1, &iattr);
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_mocStreamfunction_vertical_velocity_value",
                           15, "vertVelocityTop");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_mocStreamfunction_normal_velocity_value", 14,
                           "normalVelocity");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_mocStreamfunction_region_group", 3, "all");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "config_AM_mocStreamfunction_transect_group", 3, "all");
    NC4ERR
    err = nc_put_att_text (ncid, NC_GLOBAL, "file_id", 10, "3q7jdjett8");
    NC4ERR
...
/*----< def_G_case_h0() >----------------------------------------------------*/
int def_G_case_h0_nc4 (int ncid,                /* file ID */
                       const size_t dims_D1[1], /* dimension sizes of decomposition 1 */
                       const size_t dims_D2[1], /* dimension sizes of decomposition 2 */
                       const size_t dims_D3[2], /* dimension sizes of decomposition 3 */
                       const size_t dims_D4[2], /* dimension sizes of decomposition 4 */
                       const size_t dims_D5[2], /* dimension sizes of decomposition 5 */
                       const size_t dims_D6[2], /* dimension sizes of decomposition 6 */
                       ...
                       int *varids)             /* variable IDs */
{
    ...
    /* define dimensions */
    err = nc_def_dim (ncid, "nCells", dims_D1[0], &dim_nCells);
    NC4ERR
    err = nc_def_dim (ncid, "Time", NC_UNLIMITED, &dim_Time);
    NC4ERR
    err = nc_def_dim (ncid, "nVertLevelsP1", dims_D6[1], &dim_nVertLevelsP1);
    NC4ERR
    err = nc_def_dim (ncid, "nVertLevels", dims_D3[1], &dim_nVertLevels);
    NC4ERR
    err = nc_def_dim (ncid, "nEdges", dims_D2[0], &dim_nEdges);
    NC4ERR
    err = nc_def_dim (ncid, "nVertices", dims_D5[0], &dim_nVertices);
    NC4ERR
    err = nc_def_dim (ncid, "StrLen", 64, &dim_StrLen);
    NC4ERR
    ...
    NC4ERR
    err = nc_put_att_text (ncid, salinitySurfaceRestoringTendency, "long_name", 42,
    ...
    NC4ERR
    err = nc_put_att_text (ncid, vertAleTransportTop, "long_name", 69,
    ...
    NC4ERR
    err = nc_put_att_text (ncid, tendSSH, "long_name", 35, "time tendency of sea-surface height");
    NC4ERR
    varids[i++] = tendSSH;
    ...
    NC4ERR
    err = nc_put_att_text (ncid, layerThickness, "long_name", 15, "layer thickness");
    NC4ERR
    ...
    NC4ERR
    err = nc_put_att_text (ncid, normalVelocity, "long_name", 47,
                           "horizonal velocity, "
    ...
    NC4ERR
    err = nc_put_att_text (ncid, ssh, "long_name", 18, "sea surface height");
    NC4ERR
    varids[i++] = ssh;
    ...
    NC4ERR
    err = nc_put_att_text (ncid, maxLevelEdgeTop, "long_name", 79,
    ...
    NC4ERR
    err = nc_put_att_text (ncid, vertCoordMovementWeights, "long_name", 98,
                           "Weights used "
    ...
    NC4ERR
    err = nc_put_att_text (ncid, edgeMask, "long_name", 69,
    ...
    NC4ERR
    err = nc_put_att_text (ncid, cellMask, "long_name", 69,
    ...
    NC4ERR
    err = nc_put_att_text (ncid, vertexMask, "long_name", 75,
    ...
    NC4ERR
    err = nc_put_att_text (ncid, refZMid, "long_name", 87,
    ...
    NC4ERR
    err = nc_put_att_text (ncid, refLayerThickness, "long_name", 58,
    ...
    NC4ERR
    err = nc_put_att_text (ncid, xtime, "long_name", 45,
    ...
    NC4ERR
    err = nc_put_att_text (ncid, kineticEnergyCell, "long_name", 45,
    ...
    NC4ERR
    err = nc_put_att_text (ncid, relativeVorticityCell, "long_name", 67,
    ...
    NC4ERR
    err = nc_put_att_text (ncid, relativeVorticity, "long_name", 48,
                           "curl of horizontal velocity, "
                           "defined at vertices");
    NC4ERR
    ...
    NC4ERR
    err = nc_put_att_text (ncid, divergence, "long_name", 32, "divergence of horizonal velocity");
    NC4ERR
    varids[i++] = divergence;
    ...
    NC4ERR
    err = nc_put_att_text (ncid, areaCellGlobal, "long_name", 86,
    ...
    NC4ERR
    err = nc_put_att_text (ncid, areaEdgeGlobal, "long_name", 86,
    ...
    NC4ERR
    err = nc_put_att_text (ncid, areaTriangleGlobal, "long_name", 90,
    ...
    NC4ERR
    err = nc_put_att_text (ncid, volumeCellGlobal, "long_name", 88,
    ...
    NC4ERR
    err = nc_put_att_text (ncid, volumeEdgeGlobal, "long_name", 88,
    ...
    NC4ERR
    err = nc_put_att_text (ncid, CFLNumberGlobal, "long_name", 39,
    ...
    NC4ERR
    err = nc_put_att_text (ncid, BruntVaisalaFreqTop, "long_name", 89,
    ...
    NC4ERR
    err = nc_put_att_text (ncid, vertVelocityTop, "long_name", 79,
    ...
    NC4ERR
    err = nc_put_att_text (ncid, velocityZonal, "long_name", 58,
    ...
    NC4ERR
    err = nc_put_att_text (ncid, velocityMeridional, "long_name", 59,
                           "component of horizontal velocity in "
    ...
    NC4ERR
    err = nc_put_att_text (ncid, potentialDensity, "long_name", 80,
    ...
    NC4ERR
    err =
        nc_put_att_text (ncid, pressure, "long_name", 38, "pressure used in the momentum equation");
    NC4ERR
    varids[i++] = pressure;
    ...
    NC4ERR
    err = nc_put_att_text (ncid, refBottomDepth, "long_name", 78,
    ...
    NC4ERR
    err =
        nc_put_att_text (ncid, zMid, "long_name", 42, "z-coordinate of the mid-depth of the layer");
    NC4ERR
    varids[i++] = zMid;
    ...
    NC4ERR
    err = nc_put_att_text (ncid, bottomDepth, "long_name", 78,
    ...
    NC4ERR
    err = nc_put_att_text (ncid, maxLevelCell, "long_name", 51,
    ...
    NC4ERR
    err = nc_put_att_text (ncid, maxLevelEdgeBot, "long_name", 92,
    ...
    NC4ERR
    err = nc_put_att_text (ncid, temperatureHorizontalAdvectionTendency, "units", 26,
    ...
    NC4ERR
    err =
        nc_put_att_text (ncid, salinityHorizontalAdvectionTendency, "units", 14, "PSU per second");
    NC4ERR
    ...
    NC4ERR
    err = nc_put_att_text (ncid, temperatureVerticalAdvectionTendency, "units", 26,
                           "degrees Celsius per second");
    NC4ERR
    ...
    NC4ERR
    err = nc_put_att_text (ncid, salinityVerticalAdvectionTendency, "units", 14, "PSU per second");
    NC4ERR
    ...
    NC4ERR
    err = nc_put_att_text (ncid, temperatureVertMixTendency, "units", 26,
                           "degrees Celsius per second");
    NC4ERR
    ...
    NC4ERR
    err = nc_put_att_text (ncid, salinityVertMixTendency, "units", 14, "PSU per second");
    NC4ERR
    ...
    NC4ERR
    err = nc_put_att_text (ncid, temperatureSurfaceFluxTendency, "units", 26,
                           "degrees Celsius per second");
    NC4ERR
    ...
    NC4ERR
    err = nc_put_att_text (ncid, salinitySurfaceFluxTendency, "units", 14, "PSU per second");
    NC4ERR
    ...
    err = nc_put_att_text (ncid, temperatureShortWaveTendency, "units", 26,
                           "degrees Celsius per second");
    NC4ERR
    err = nc_put_att_text (ncid, temperatureShortWaveTendency, "long_name", 59,
    ...
    NC4ERR
    err = nc_put_att_text (ncid, temperatureNonLocalTendency, "units", 26,
                           "degrees Celsius per second");
    NC4ERR
    ...
    NC4ERR
    err = nc_put_att_text (ncid, salinityNonLocalTendency, "units", 14, "PSU per second");
    NC4ERR
    ...
    NC4ERR
    err = nc_put_att_text (ncid, temperature, "units", 15, "degrees Celsius");
    NC4ERR
    ...
    NC4ERR
    err = nc_put_att_text (ncid, salinity, "units", 32, "grams salt per kilogram seawater");
    NC4ERR
    varids[i++] = salinity;
...
#define GET_ATT_TEXT(A, B, C, D, E) nc_get_att_text (A, B, C, txtbuf)
#define GET_ATT(A, B, C, D, E, F)   nc_get_att (A, B, C, F)
...
/*----< def_G_case_h0() >----------------------------------------------------*/
int inq_G_case_h0_nc4 (int ncid,          /* file ID */
                       size_t dims_D1[1], /* dimension sizes of decomposition 1 */
                       size_t dims_D2[1], /* dimension sizes of decomposition 2 */
                       size_t dims_D3[2], /* dimension sizes of decomposition 3 */
                       size_t dims_D4[2], /* dimension sizes of decomposition 4 */
                       size_t dims_D5[2], /* dimension sizes of decomposition 5 */
                       size_t dims_D6[2], /* dimension sizes of decomposition 6 */
                       int nvars,         /* number of variables */
                       int *varids)       /* variable IDs */
{
    /* Total 52 variables */
    ...
    // err = define_global_attributes(ncid); NC4ERR

    /* define dimensions */
    /*
    err = nc_def_dim(ncid, "nCells", dims_D1[0], &dim_nCells); NC4ERR
    err = nc_def_dim(ncid, "Time", NC_UNLIMITED, &dim_Time); NC4ERR
    err = nc_def_dim(ncid, "nVertLevelsP1", dims_D6[1], &dim_nVertLevelsP1); NC4ERR
    err = nc_def_dim(ncid, "nVertLevels", dims_D3[1], &dim_nVertLevels); NC4ERR
    err = nc_def_dim(ncid, "nEdges", dims_D2[0], &dim_nEdges); NC4ERR
    err = nc_def_dim(ncid, "nVertices", dims_D5[0], &dim_nVertices); NC4ERR
    err = nc_def_dim(ncid, "StrLen", 64, &dim_StrLen); NC4ERR
    */

    err = nc_inq_dimid (ncid, "nCells", &dim_nCells);
    NC4ERR
    err = nc_inq_dimid (ncid, "nVertLevelsP1", &dim_nVertLevelsP1);
    NC4ERR
    err = nc_inq_dimid (ncid, "nVertLevels", &dim_nVertLevels);
    NC4ERR
    err = nc_inq_dimid (ncid, "nEdges", &dim_nEdges);
    NC4ERR
    err = nc_inq_dimid (ncid, "nVertices", &dim_nVertices);
    NC4ERR

    err = nc_inq_dimlen (ncid, dim_nCells, &(((size_t *)dims_D1)[0]));
    NC4ERR
    err = nc_inq_dimlen (ncid, dim_nVertLevelsP1, &(((size_t *)dims_D6)[1]));
    NC4ERR
    err = nc_inq_dimlen (ncid, dim_nVertLevels, &(((size_t *)dims_D3)[1]));
    NC4ERR
    err = nc_inq_dimlen (ncid, dim_nEdges, &(((size_t *)dims_D2)[0]));
    NC4ERR
    err = nc_inq_dimlen (ncid, dim_nVertices, &(((size_t *)dims_D5)[0]));
    NC4ERR
